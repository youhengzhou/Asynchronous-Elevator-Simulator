...
/**
 * Custom error for incorrect ElevatorStatusObj conversion.
 *
 * @author Tony Zeidan
 * @author Evan Lloyd
 * @author Shaopeng Liu
 ...
 */
public class ElevatorStatusObjConversionException extends RuntimeException {
     ...
     */
    public ElevatorStatusObjConversionException(boolean toPacket, String errmsg) {
        super(String.format(
                "There was a problem translating a ElevatorStatusObj %s.\n%s",
